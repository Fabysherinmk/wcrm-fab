...
export const chartColors = {
  ...
  // Theme-driven accent. Unlike the fixed Tailwind hues above, these
  // resolve to the active theme's `--primary` via the `*-primary`
  // utilities registered in globals.css `@theme` — so a chart that
  // opts into `primary` recolours when the user switches theme.
  primary: {
    bg: "bg-primary",

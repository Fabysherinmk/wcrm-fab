...
//   3. `ResponsiveContainer` is given a positive `initialDimension`
//      so the first render (before the ResizeObserver measures the
//      parent) doesn't compute a -1×-1 chart and log Recharts'
...
const BarChart = React.forwardRef<HTMLDivElement, BarChartProps>(
  (props, forwardedRef) => {
    ...
    return (
      ...
      >
        {/*
          Seed a positive initial size so the first render — before the
          ResizeObserver measures the parent — doesn't compute a -1×-1
          chart and log Recharts' "width(-1) and height(-1)" warning.
          These are a transient placeholder; the observer overwrites them
          with the real container dimensions on mount.
        */}

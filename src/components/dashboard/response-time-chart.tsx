      ...
      <div className="p-5">
        {loading || !data ? (
          ...
          <BarChart
            ...
            index="day"
            categories={[CATEGORY]}
            // Use the active theme's primary so the bars match the rest
            // of the UI and recolour on theme switches. `fill-primary`
            // exists because `--color-primary` is registered in @theme.
            colors={['primary']}
